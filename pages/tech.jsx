...
const tech = () => {
  const data = [
  {
    ...
    desc: "My go-to code editor for building, debugging, and shipping projects faster.",
    tag: "code",
    bg: "bg-blue-50",
    text: "text-blue-500",
  },
  {
    ...
    desc: "A lightweight programming language used to build interactive and dynamic web applications.",
    tag: "code",
    bg: "bg-yellow-50",
  ...
  },
  {
    ...
    desc: "JavaScript with type safety, making large frontend and full-stack applications more reliable.",
    tag: "code",
    bg: "bg-blue-50",
    text: "text-blue-500",
  },
  {
    ...
    desc: "A frontend library for building clean, reusable, and interactive user interfaces.",
    tag: "frontend",
    bg: "bg-blue-50",
    text: "text-blue-500",
  },
  {
    ...
    desc: "A React framework used for server-side rendering, routing, SEO, and full-stack web apps.",
    tag: "fullstack",
    bg: "bg-gray-900",
    text: "text-gray-50",
  },
  {
    ...
    desc: "A utility-first CSS framework for building modern and responsive interfaces quickly.",
    tag: "design",
    bg: "bg-green-50",
    text: "text-green-500",
  },
  {
    ...
    desc: "A component library that helps build polished React interfaces faster.",
    tag: "frontend",
    bg: "bg-indigo-50",
  ...
  },
  {
    ...
    desc: "A design tool used for wireframes, prototypes, and UI collaboration.",
    tag: "design",
    bg: "bg-orange-500",
  ...
  },
  {
    ...
    desc: "A platform for version control, collaboration, and showcasing code.",
    tag: "platform",
    bg: "bg-gray-900",
    text: "text-gray-100",
  },
